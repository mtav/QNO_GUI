...
def drawCards(qno, numCards):
    cardsDrawn=[]
    for x in range(numCards):
        cardsDrawn.append(qno.unoDeck.pop(0))
    return cardsDrawn
...
def canPlay(state, value, playerHand):
    for card in playerHand:
        if card[0]=="Gate":
            return True
        if card[0]==state:
            return True
        if card[1]==value in card:
            # print(card[1]==value)
            # print(card[1]==value in card)
            # print(card)
            # print(state)
            # print(value)
            # raise
...
def measurementGuessOutcome(measurement_guess, random_bit, players):
    if measurement_guess==random_bit:
        print("Correct guess. The next player has to draw 4 cards!")
        nextPlayer=playerTurn+playDirection
        ...
        print("Incorrect guess. Draw a card!")
        players[playerTurn]+=(drawCards(1))

        if players[playerTurn][-1][0]=="|00>":
            print("You drew: " ,  "[" , color.RED , color.BOLD , players[playerTurn][-1][0] , "  " , players[playerTurn][-1][1] , color.END , "]" )
        elif players[playerTurn][-1][0]=="|01>":
            print("You drew: " ,  "[" , color.YELLOW , color.BOLD , players[playerTurn][-1][0] ,"  ", players[playerTurn][-1][1] , color.END , "]" )
        elif players[playerTurn][-1][0]=="|10>":
            print("You drew: " ,  "[" , color.GREEN , color.BOLD , players[playerTurn][-1][0] ,"  ", players[playerTurn][-1][1] , color.END , "]" )
        elif players[playerTurn][-1][0]=="|11>":
            print("You drew: " ,  "[" , color.BLUE , color.BOLD , players[playerTurn][-1][0] ,"  ", players[playerTurn][-1][1] , color.END , "]" )
        else:
            print("You drew: " ,  "[" , color.BOLD , players[playerTurn][-1][1] , color.END , color.RED , color.BOLD , "G" , color.END, color.YELLOW , color.BOLD , "A" ,color.END, color.GREEN , color.BOLD , "T", color.END, color.BLUE , color.BOLD , "E" , color.END , "]" )
...
def main():
    ...
    numPlayers=int(input("How many people are playing (enter an integer from 2 to 4)?"))
    while numPlayers<2 or numPlayers>4:
        numPlayers=int(input("Invalid. Please enter a number between 2 and 4. How many people are playing?"))

    for player in range(numPlayers):
        players.append(drawCards(qno, 5))
    ...
    More information on basis states, quantum gates, and superpositions can be found in the quantum information section.
    """
    ...
    while playing:
        ...
        if discards[-1][0]=="|00>":
            print("Card on top of discard pile is: " ,  "[" , color.RED , color.BOLD , discards[-1][0] , "  " , discards[-1][1] , color.END , "]" )
        elif discards[-1][0]=="|01>":
            print("Card on top of discard pile is: " ,  "[" , color.YELLOW , color.BOLD , discards[-1][0] ,"  ", discards[-1][1] , color.END , "]" )
        elif discards[-1][0]=="|10>":
            print("Card on top of discard pile is: " ,  "[" , color.GREEN , color.BOLD , discards[-1][0] ,"  ", discards[-1][1] , color.END , "]" )
        elif discards[-1][0]=="|11>":
            print("Card on top of discard pile is: " ,  "[" , color.BLUE , color.BOLD , discards[-1][0] ,"  ", discards[-1][1] , color.END , "]" )
        else:
            print("Card on top of discard pile is: " ,  "[" , color.BOLD , discards[-1][1] , color.END , color.RED , color.BOLD , "G" , color.END, color.YELLOW , color.BOLD , "A" ,color.END, color.GREEN , color.BOLD , "T", color.END, color.BLUE , color.BOLD , "E" , color.END , "]" )


        SeeAboutRulesCircuit=input("""
        Do you want to get more information about QNO?
    
        Do you want to see see the rules for QNO?
    
        Do you want to get information on the quantum computing involved in QNO?
    
        Do you want to visualize a quantum circuit corresponding to this game?
    
        If the answer to any of these questions is yes enter yes, otherwise enter anything else.""")

        while SeeAboutRulesCircuit == "yes":
            WhichAboutRulesCircuit=input("""
    
            Enter a to get more information about QNO!
    
            Enter r to see the rules for QNO!
    
            Enter q to get information about the quantum computing involved in QNO!
    
            Enter c to draw a quantum circuit corresponding to this game!""")

            if WhichAboutRulesCircuit=="a":
                print(About)
            elif WhichAboutRulesCircuit=="r":
                print(Rules)
            elif WhichAboutRulesCircuit=="q":
                print(Quantum_Information)
            elif WhichAboutRulesCircuit=="c":
                print("Here is a quantum circuit associated with your game. Note that this is not the only quantum circuit associated with your game.")
                print(qc)
                qc.draw()
        ...
        currentState=discards[-1][0]
        cardVal=discards[-1][1]

        if len(discards)>1:
            secondcardState=discards[-2][0]
            secondcardVal=discards[-2][1]


        if canPlay(currentState, cardVal, players[playerTurn]):
            cardChosen=int(input("Which card do you want to play? Enter the integer position of the card in your hand. This value can be found to the left of the card."))
            while not canPlay(currentState, cardVal, [players[playerTurn][cardChosen-1]]):
                cardChosen=int(input("Not a valid card. Which card do you want to play? Enter the integer position of the card in your hand. This value can be found to the left of the card."))

            if currentState=="|00>":

                if players[playerTurn][cardChosen-1][0]=="|11>":
                    qc.x(0)
                    qc.x(1)
                elif players[playerTurn][cardChosen-1][0]=="|10>":
                    qc.x(1)
                elif players[playerTurn][cardChosen-1][0]=="|01>":
                    qc.x(0)
                ...
                if players[playerTurn][cardChosen-1][0]=="|11>":
                    ...
                    qc.x(0)
                    qc.x(1)
                elif players[playerTurn][cardChosen-1][0]=="|00>":
                    qc.x(0)
                ...
                if players[playerTurn][cardChosen-1][0]=="|10>":
                    qc.x(0)
                elif players[playerTurn][cardChosen-1][0]=="|00>":
                    qc.x(0)
                    qc.x(1)
            ...
            print ("You have no cards you can play. You have to draw a card.")
            players[playerTurn]+=(drawCards(1))
        ...
        if currentState == "Gate":
            if cardVal== "CNOT":
                cardVal="CNOT"
                whichQubit=int(input("Which qubit (0 or 1) do you want to make the control qubit?"))

                while whichQubit>1 or whichQubit<0:
                    whichQubit=int(input("Invalid option. Which qubit (0 or 1) do you want to make the control qubit?"))

                if secondcardState=="|01>" and whichQubit==0:
                    currentState="|11>"
                    qc.cx(0,1)

                elif secondcardState=="|11>" and whichQubit==0:
                    currentState="|01>"
                    qc.cx(0,1)

                elif secondcardState=="|10>" and whichQubit==1:
                    currentState="|11>"
                    qc.cx(1,0)

                elif secondcardState=="|11>" and whichQubit==1:
                    currentState="|10>"
                    qc.cx(1,0)

                elif whichQubit==0:
                    currentState=secondcardState
                    qc.cx(0,1)
                ...
                cardVal="X"
                whichQubit=int(input("Which qubit (0 or 1) do you want to send through the X gate?"))

                while whichQubit>1 or whichQubit<0:
                    whichQubit=int(input("Invalid option. Which qubit (0 or 1) do you want to send through the X gate?"))

                if secondcardState =="|00>" and whichQubit==0:
                    currentState="|01>"
                    qc.x(0)

                elif secondcardState =="|00>" and whichQubit==1:
                    currentState="|10>"
                    qc.x(1)

                elif secondcardState =="|10>" and whichQubit==0:
                    currentState="|11>"
                    qc.x(0)
                ...
                elif secondcardState =="|01>" and whichQubit==0:
                    currentState="|00>"
                    qc.x(0)

                elif secondcardState =="|01>" and whichQubit==1:
                    currentState="|11>"
                    qc.x(1)
                ...
                whichQubit=int(input("Which qubit (0 or 1) do you want to send through the H gate?"))

                while whichQubit>1 or whichQubit<0:
                    whichQubit=int(input("Invalid option. Which qubit (0 or 1) do you want to send through the H gate?"))

                random_bit=random.getrandbits(1)

                if secondcardState=="|00>" and whichQubit==1:
                    currentState="1/sqrt(2)(|00>+|10>)"

                    qc.h(1)

                    print("The current state is the superposition: " ,  "1/sqrt(2)(" , color.RED, color.BOLD , "|00>", color.END, "+", color.GREEN, color.BOLD, "|10>", color.END, ")" )
                    ...
                    print("Your quantum state was measured to collapse the superposition!")

                    measurement_guess=int(input("Type 0 to guess we have state |00> and 1 to guess we have state |10> after the measurement."))

                    while measurement_guess!=0 and measurement_guess!=1:
                        measurement_guess=int(input("Enter 0 to guess we have state |00> and 1 to guess we have state |10> after the measurement."))


                    measurementGuessOutcome(measurement_guess, random_bit, players)


                elif secondcardState=="|00>" and whichQubit==0:
                    currentState="1/sqrt(2)(|00>+|01>)"
                    qc.h(0)
                    print("The current state is the superposition: " ,  "1/sqrt(2)(" , color.RED, color.BOLD , "|00>", color.END, "+", color.YELLOW, color.BOLD, "|01>", color.END, ")" )
                    if random_bit==0:
                          currentState="|00>"
                    else:
                          currentState="|01>"
                    ...
                    measurement_guess=int(input("Type 0 to guess we have state |00> and 1 to guess we have state |01> after the measurement."))

                    while measurement_guess!=0 and measurement_guess!=1:
                        measurement_guess=int(input("Enter 0 to guess we have state |00> and 1 to guess we have state |01> after the measurement."))
                    ...
                    currentState="1/sqrt(2)(|10>+|11>)"
                    qc.h(0)
                    print("The current state is the superposition: ", "1/sqrt(2)(" , color.GREEN, color.BOLD , "|10>", color.END, "+", color.BLUE, color.BOLD, "|11>", color.END, ")")
                    if random_bit==0:
                          currentState="|10>"
                    else:
                          currentState="|11>"
                    ...
                    measurement_guess=int(input("Type 0 to guess we have state |10> and 1 to guess we have state |11> after the measurement."))

                    while measurement_guess!=0 and measurement_guess!=1:
                        measurement_guess=int(input("Enter 0 to guess we have state |10> and 1 to guess we have state |11> after the measurement."))
                    ...
                    currentState="1/sqrt(2)(|01>+|11>)"
                    qc.h(1)
                    print("The current state is the superposition: ", "1/sqrt(2)(" , color.YELLOW, color.BOLD , "|01>", color.END, "+", color.BLUE, color.BOLD, "|11>", color.END, ")")
                    if random_bit==0:
                          currentState="|01>"
                    else:
                          currentState="|11>"
                    ...
                    measurement_guess=int(input("Type 0 to guess we have state |01> and 1 to guess we have state |11> after the measurement."))

                    while measurement_guess!=0 and measurement_guess!=1:
                        measurement_guess=int(input("Enter 0 to guess we have state |01> and 1 to guess we have state |11> after the measurement."))
        ...
        discards.append([currentState,cardVal])

        if discards[-1][0]=="|00>":
            print("Card on top of discard pile is now: " ,  "[" , color.RED , color.BOLD , discards[-1][0] , "  " , discards[-1][1] , color.END , "]" )
        elif discards[-1][0]=="|01>":
            print("Card on top of discard pile is now: " ,  "[" , color.YELLOW , color.BOLD , discards[-1][0] ,"  ", discards[-1][1] , color.END , "]" )
        elif discards[-1][0]=="|10>":
            print("Card on top of discard pile is now: " ,  "[" , color.GREEN , color.BOLD , discards[-1][0] ,"  ", discards[-1][1] , color.END , "]" )
        elif discards[-1][0]=="|11>":
            print("Card on top of discard pile is now: " ,  "[" , color.BLUE , color.BOLD , discards[-1][0] ,"  ", discards[-1][1] , color.END , "]" )
        else:
            print("Card on top of discard pile is now: " ,  "[" , color.BOLD , discards[-1][1] , color.END , color.RED , color.BOLD , "G" , color.END, color.YELLOW , color.BOLD , "A" ,color.END, color.GREEN , color.BOLD , "T", color.END, color.BLUE , color.BOLD , "E" , color.END , "]" )
        ...
        if len(players[playerTurn])==0:
            print("Player" +str(playerTurn+1) + "wins!")
            print("Here is the quantum circuit associated with your game: ")
            print(qc)
            qc.draw()
            playing=False


        Ready=input("Are you done with your turn (yes or no)?")
        while Ready!="yes":

            WhichAboutRulesCircuit=input("""
    
            Enter a to get information about QNO!
        ...
        Ready=input("Type yes if you are player " + str(playerTurn+playDirection) + ". ")
...
def test_canPlay():
    qno1 = QNO_vars()
    qno2 = QNO_vars()
    qno1.unoDeck = buildDeck()
    qno2.unoDeck = buildDeck()
    for c1 in qno1.unoDeck:
        for c2 in qno2.unoDeck:
            # print(c1,c2)
            state=c2[0]
            value=c2[1]
            playerHand=[c1]
            res = canPlay(state, value, playerHand)
            print(c1,c2,res)
    pass
